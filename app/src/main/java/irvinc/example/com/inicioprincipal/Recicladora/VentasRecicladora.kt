...
//                val spMaterial = p0.itemView.findViewById<Spinner>(R.id.spMaterialVendido_registroVenta)
                val tvCantidad = p0.itemView.findViewById<TextView>(R.id.tvCantidad_ventasRecicladora)
//                val spUnidad = p0.itemView.findViewById<Spinner>(R.id.spUnidad_registroVenta)
